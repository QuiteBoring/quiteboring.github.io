...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 w-full pt-4.5 p-3.5 bg-slate-800 border-b border-slate-900 flex justify-between items-center backdrop-blur-sm">
      ...
      <div className="hidden md:flex items-center space-x-4 mr-3 sm:mr-5">
        <Link
          href="/cobalt/roadmap"
      ...
      <div
        className={`fixed left-0 right-0 w-full md:hidden bg-slate-800 backdrop-blur-sm border-t border-slate-900 shadow-xl transition-all duration-300 z-40 ${
          isMenuOpen
